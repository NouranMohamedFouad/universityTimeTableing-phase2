...
public class CurriculaCourses extends Composite implements SimpleForm.HasMobileScroll {
	...
	private int compareTwoRows(int column, int r0, int r1) {
		...
		if (column % 2 == 0) {
			...
			//make original values instead /* BUG */
			...
			if (s0 == null && s1 == null) {
			    ...
			    return -1;
			} else if (s0 == Float.MIN_VALUE && s1 == Float.MIN_VALUE) {
			    return 0;
			} else if (s0 == Float.MIN_VALUE) {
			    return 1;
			} else if (s1 == Float.MIN_VALUE) {
			    return -1;
			} else {
			    return Float.compare(s1, s0);
			}
		} else { 
			...
			//use original values instead /* BUG */
			if (i0 == null && i1 == null) {
			    return 0;
			} else if (i0 == null) {
			    return 1;
